...
setwd("C:/Users/Mason Kulbaba/Dropbox/git/adaptive-capacity/confidence_intervals/GC/2016")
...
VaW <- function (rout2016){
  ...
  est <- 4*moom.star[2274 , 5]^2 * rout2016$nu[1]/map(0) # final calcuation of additive genetic variance for fitness
  # SE
  se <- 4*moom.star[2274,5]^2 * sout$nu["parental", "Std. Error"]/map(0)
