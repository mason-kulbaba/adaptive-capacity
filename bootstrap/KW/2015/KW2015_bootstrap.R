...
setwd("C:/Users/Mason Kulbaba/Dropbox/Rscripts/chamaecrista-adaptive-capacity/bootstrap/KW/2015")
...
save.image("doubleboot_KW2015_run.RData")

# Generate Va(W) from data
KW_Va.hat <- VaW(rout2015) # generates Va(W) from data
